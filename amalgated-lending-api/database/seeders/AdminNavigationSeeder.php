...
class AdminNavigationSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            ['path' => '/admin/borrowers/archived', 'label' => 'Archived Borrowers', 'icon_key' => 'borrowers', 'sort_order' => 41, 'permission_slug' => 'borrowers.view', 'match_end' => false],
            ['path' => '/admin/loan-products', 'label' => 'Loan Products', 'icon_key' => 'products', 'sort_order' => 45, 'permission_slug' => 'loans.view', 'match_end' => false],
            ['path' => '/admin/applications', 'label' => 'Applications', 'icon_key' => 'loans', 'sort_order' => 50, 'permission_slug' => 'loans.view', 'match_end' => true],
            ['path' => '/admin/applications/archived', 'label' => 'Archived Applications', 'icon_key' => 'loans', 'sort_order' => 51, 'permission_slug' => 'loans.view', 'match_end' => false],
            ...
            ['path' => '/admin/soa', 'label' => 'SOA Management', 'icon_key' => 'report', 'sort_order' => 66, 'permission_slug' => 'soa.view', 'match_end' => false],
