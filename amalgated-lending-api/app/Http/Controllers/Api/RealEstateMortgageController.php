...
class RealEstateMortgageController extends Controller
{
    ...
    public function apply(Request $request): JsonResponse
    {
        ...
        app(NotificationCenter::class)->notifyStaff(
            ...
            'loan_submitted',
            'Real Estate Mortgage application',
            'New REM application from '.$borrower->name.' — ₱'.number_format((float) $loan->principal, 2),
    ...
    private function notifyBorrower(User $borrower, Loan $loan): void
    {
        $this->loanMail->sendReceived(
            $borrower,
            $loan,
            'We received your Real Estate Mortgage application — Amalgated Lending Inc.',
        );
    }
}
