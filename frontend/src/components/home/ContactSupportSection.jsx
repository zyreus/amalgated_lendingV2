  ...
  return (
    <section id="contact-support" className="app-container landing-section">
      <div className="landing-card-grid items-stretch lg:grid-cols-2">
        ...
        <div className="flex min-h-[24rem] overflow-hidden rounded-2xl border border-red-100/50 bg-white p-1 shadow-[0_12px_40px_rgba(230,57,70,0.08),0_4px_20px_rgba(0,0,0,0.05)] lg:min-h-full">
          <iframe
