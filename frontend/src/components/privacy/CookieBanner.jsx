...
export default function CookieBanner({ onOpenPreferences, onConsentSaved }) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[65] px-3 pb-3 sm:px-6 sm:pb-6">
      <div
        className="mx-auto w-full max-w-4xl rounded-2xl border border-black/10 bg-white/95 p-4 shadow-2xl backdrop-blur dark:border-white/10 dark:bg-zinc-900/95 sm:p-5"
