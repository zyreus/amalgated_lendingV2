    ...
    >
      <div className="app-container flex items-center justify-between gap-2 py-3 sm:gap-3 sm:py-3.5 lg:gap-4 lg:py-3.5 xl:gap-6 xl:py-4">
        ...
        <div className="hidden min-w-0 flex-1 items-center justify-center lg:flex">
          <nav
            className="flex min-w-0 max-w-full flex-nowrap items-center justify-center gap-x-1.5 px-0.5 sm:px-0 xl:gap-x-2 2xl:gap-x-2.5"
          ...
          >
            ...
            <div className="relative shrink-0" onMouseEnter={() => { clearCloseTimer(); setOpenMenu('calculator') }} onMouseLeave={scheduleClose}>
          ...
          <div className="relative shrink-0" onMouseEnter={() => { clearCloseTimer(); setOpenMenu('news') }} onMouseLeave={scheduleClose}>
          ...
          <div className="relative shrink-0" onMouseEnter={() => { clearCloseTimer(); setOpenMenu('loans') }} onMouseLeave={scheduleClose}>
            {triggerBtn('loans', 'Loan products')}
            <MegaPanel menuKey="loans" widthClass="w-[min(100vw-2rem,680px)] sm:w-[min(100vw-2rem,820px)]">
          ...
          <div className="relative shrink-0" onMouseEnter={() => { clearCloseTimer(); setOpenMenu('resources') }} onMouseLeave={scheduleClose}>
            {triggerBtn('resources', 'Resources')}
            <MegaPanel menuKey="resources" widthClass="w-[min(100vw-2rem,640px)] sm:w-[min(100vw-2rem,760px)]">
              ...
              <div className="mt-4 grid gap-4 lg:grid-cols-12 lg:gap-5">
                <div className="grid gap-3 sm:grid-cols-2 lg:col-span-5">
                  <Link
                    to="/application-flow"
                    className={loanMegaCardClass}
                    onClick={() => setOpenMenu(null)}
                  >
                    <span className="text-sm font-semibold text-brand-text group-hover:text-brand-primary dark:text-white">Application flow</span>
                    ...
                    <span className="mt-3 text-xs font-semibold text-brand-primary">Open guide →</span>
                  </Link>
                  <Link
                    to="/privacy-policy"
                    className={loanMegaCardClass}
                    onClick={() => setOpenMenu(null)}
                  >
                    <span className="text-sm font-semibold text-brand-text group-hover:text-brand-primary dark:text-white">Privacy policy</span>
                    <span className="mt-2 block text-xs leading-relaxed text-brand-text/65 dark:text-white/62">
                      How we handle personal data, cookies, and your rights as a borrower.
                    </span>
                    <span className="mt-3 text-xs font-semibold text-brand-primary">Read policy →</span>
                  </Link>
                </div>
                <div className="grid gap-3 sm:grid-cols-2 lg:col-span-7">
                  <div className="rounded-xl border border-brand-primary/20 bg-gradient-to-br from-brand-primary/[0.12] via-white to-white p-4 dark:from-brand-primary/20 dark:via-[#111827] dark:to-[#0f172a]">
                  ...
                  <div className="flex flex-col justify-between rounded-xl border border-black/[0.07] bg-black/[0.02] p-4 dark:border-white/10 dark:bg-white/[0.04]">
                    <div>
                    ...
                    <Link
                      to="/application-flow"
                      className="mt-4 inline-flex w-fit items-center rounded-lg border border-brand-primary/35 bg-white px-3 py-2 text-xs font-semibold text-brand-primary shadow-sm transition hover:bg-brand-primary/5 dark:bg-[#111827] dark:hover:bg-brand-primary/10"
                      onClick={() => setOpenMenu(null)}
                    >
                      Learn more
                    </Link>
            ...
            <div className="relative shrink-0" onMouseEnter={() => { clearCloseTimer(); setOpenMenu('branches') }} onMouseLeave={scheduleClose}>
          ...
          <div className="relative shrink-0" onMouseEnter={() => { clearCloseTimer(); setOpenMenu('careers') }} onMouseLeave={scheduleClose}>
            {triggerBtn('careers', 'Careers')}
            <MegaPanel menuKey="careers" align="right">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-brand-primary">Join our team</p>
              <p className="mt-2 text-sm text-brand-text/75 dark:text-white/75">
                Operations, credit risk, and customer experience roles in Davao. Structured interviews and skills assessments.
              </p>
              <ul className="mt-3 list-disc space-y-1 pl-4 text-xs text-brand-text/70 dark:text-white/65">
                <li>Open roles &amp; culture</li>
                <li>Hiring process overview</li>
                <li>Apply via email or contact form</li>
              </ul>
              <Link
                to="/careers"
                className="mt-4 inline-flex rounded-full bg-brand-primary px-4 py-2 text-xs font-semibold text-white hover:bg-brand-primary-hover"
            ...
            <div className="app-container max-h-[min(80vh,640px)] space-y-1 overflow-y-auto py-4">
              ...
              <div className="rounded-xl border border-black/8 dark:border-white/10">
                ...
                {mobileAccordion === 'resources' ? (
                  <div className="border-t border-black/8 space-y-3 px-2 py-3 dark:border-white/10">
              ...
              <Link to="/careers" className="block rounded-xl border border-black/8 px-3 py-3 text-sm font-semibold hover:bg-black/[0.04] dark:border-white/10 dark:hover:bg-white/5" onClick={() => setMobileOpen(false)}>
                Careers
              </Link>
