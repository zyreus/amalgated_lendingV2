...
export const admin = {
  ...
  shell:
    'bg-brand-cream text-gray-900 transition-colors duration-300 dark:bg-[#0F172A] dark:text-gray-100',
  ...
  btnPrimary:
    'touch-manipulation rounded-xl bg-brand-primary px-4 py-2.5 text-sm font-semibold text-white shadow-md transition duration-200 hover:bg-brand-primary-hover hover:shadow-lg',
  btnSecondary:
  ...
  input:
    'rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 outline-none transition duration-300 placeholder:text-gray-500 focus:border-brand-primary/40 focus:ring-2 focus:ring-brand-primary/15 dark:border-[#1F2937] dark:bg-[#111827] dark:text-gray-100 dark:placeholder:text-gray-400',
  tableWrap:
  ...
  filterActive: 'bg-brand-primary text-white shadow-md ring-1 ring-brand-primary/30',
}
