      ...
      >
        <div className="flex min-h-0 flex-1 flex-col md:flex-row">
          ...
          <div className="flex min-h-0 min-w-0 flex-1 flex-col">
            <div className="shrink-0 border-b border-gray-100 px-5 py-4 dark:border-[#1F2937] sm:px-6">
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="-mr-1 shrink-0 rounded-xl p-2 text-gray-500 transition hover:bg-gray-100 hover:text-gray-800 disabled:opacity-50 dark:hover:bg-[#1F2937]"
                  aria-label="Close"
                >
                  <X className="size-5" />
                </button>
              </div>
              <h3 id="manual-payment-title" className="mt-2 text-lg font-semibold text-gray-900 dark:text-gray-100">
                {STEPS[step - 1]?.title}
              </h3>
            ...
            <div className="mt-auto shrink-0 border-t border-gray-100 bg-gray-50/80 px-5 py-4 dark:border-[#1F2937] dark:bg-[#0F172A]/30 sm:px-6">
              <div className="flex items-center justify-between gap-3">
                <button
                  type="button"
                  className={`${admin.btnSecondary} shrink-0`}
                ...
                {step < 3 ? (
                  <button
                    type="button"
                    className={`${admin.btnPrimary} inline-flex shrink-0 items-center gap-1`}
                    disabled={
                      manualSaving ||
                  ...
                  <button
                    type="button"
                    className={`${admin.btnPrimary} inline-flex shrink-0 items-center gap-2`}
